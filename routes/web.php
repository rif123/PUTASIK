...
Route::group(['middleware' => 'CheckDataLogin' ],function() {
	...
	Route::group(['namespace' => 'Admin', 'prefix' => 'admin'],function() {
		...
		Route::get('/districts/delete',['uses' => 'HomeDistrictsController@delete', 'as' => 'districts.delete']);
		...
		Route::get('/delete-barang',['uses' => 'MasterStatusBarangController@delete', 'as' => 'deleteBarang']);
		...
		Route::get('/delete-user',['uses' => 'MasterUserController@delete', 'as' => 'deleteUser']);
		...
		Route::get('/village/delete',['uses' => 'MasterVillageController@delete', 'as' => 'village.delete']);
